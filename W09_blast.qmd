...
[NASA](https://earthobservatory.nasa.gov/images/147098/scientists-map-beirut-blast-damage) used Sentinel-1 imagery in the aftermath of the explosion to generate an estimated damage map. They explain that Sentinel-1 Synthetic Aperture Radar (SAR) imagery is good for this sort of task:
...
On 6 February 2023, a devastating earthquake hit Souhthern Turkey. The earthquake had a magnitude of 7.8 and caused widespread damage. The epicentre was near the city of Kahramanmaras (36.92647, 37.574), and  was felt as far away as Cyprus. It is estimated to have left 1.5 million people homeless. I worked with the [Economist](https://archive.is/XC0UO) to deploy the Pixelwise T-Test algorithm to detect damaged buildings in the aftermath. Using the code from this practical, try to detect the damage from the earthquake in Southern Turkey, and use last week's code to build a user interface that allows users to get the count of damaged buildings within a given area.

Once you've tried this yourself, you can check your attempt against [this link](https://code.earthengine.google.com/e42d562a41ef75bee179d8dfa34a18c7) which contains my implementation:
